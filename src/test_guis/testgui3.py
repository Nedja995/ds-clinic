...
class BackMeUp(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        image_files = {
            ...
            # 'logo': 'backup.png'
            'properties-dark': 'icon_settings.png',
            'properties-light': 'icon_settings.png',
            'add-to-backup-dark': 'icon_settings.png',
            'add-to-backup-light': 'icon_settings.png',
            'stop-backup-dark': 'icon_settings.png',
            'stop-backup-light': 'icon_settings.png',
            'play': 'icon_settings.png',
            'refresh': 'icon_settings.png',
            'stop-dark': 'icon_settings.png',
            'stop-light': 'icon_settings.png',
            'opened-folder': 'icon_settings.png',
            'logo': 'icon_settings.png'
        }

        self.photoimages = []
        imgpath = utils.get_resource_dirpath()
        for key, val in image_files.items():
            _path = utils.get_resource_filepath(val)
...
class CollapsingFrame(ttk.Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.images = [
            ...
            ttk.PhotoImage(file=utils.get_resource_filepath('icon_settings.png')),
            ttk.PhotoImage(file=utils.get_resource_filepath('icon_settings.png'))
        ]
